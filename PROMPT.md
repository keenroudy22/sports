...
Model leans, prop leans and longshots are never favorites. All four kinds go to X, each labeled for what it is: a lean says "our number alone", the longshot says "fun ticket, quarter unit". A full game day carries them in that order of priority, and zero of any of them is fine.
