...
Model leans, prop leans and longshots are never favorites. Favorites, model leans and prop leans go to X, each labeled for what it is (a lean says "our number alone"); longshots do not. A full game day carries them in that order of priority, and zero of any of them is fine.
